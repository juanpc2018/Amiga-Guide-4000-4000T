...
Gotek USB Floppy Emulators "STM32" with optional [HxC Firmware](https://hxc2001.com/docs/gotek-floppy-emulator-hxc-firmware/pages/firmware-update.html), [Cortex](https://cortexamigafloppydrive.wordpress.com/) Firmware, [FlashFloppy](https://github.com/keirf/flashfloppy) FirmWare, converting files to .adf image format, using Xcopy or similar Amiga SW, [EasyADF](https://www.easyadf.com/index.php?currency=USD), Reading on PC: [Disk2FDI](http://www.oldskool.org/disk2fdi/trial.html) </br>
...
## GPU's
Older GPU's like [PicassoIV v1.2](https://amiga.resource.cx/exp/picasso4).[wiki](https://www.amigawiki.org/doku.php?id=en:expansion:av:picasso_iv).[bbah](https://bigbookofamigahardware.com/bboah/product.aspx?id=468).[sd](https://www.sophisticated-development.de/software/index.php/P-IV).[sch](http://amiga.serveftp.net/Schematics/VillageTronic/) & [Piccolo SD64](https://www.youtube.com/watch?v=bqqmQgWlQX0).[cx](https://amiga.resource.cx/exp/piccolosd64) </br>
...
be quiet! [DARK POWER 14 850W](https://www.bequiet.com/en/powersupply/5790) has 24A, -2A short. </br>
...
[RetroFletch](https://www.tindie.com/stores/retrofletch/items/) </br>
...
3D Render Test 060 at 100MHz: [14 sec](https://www.youtube.com/watch?v=QFajUKxel1U&t=1114s) </br>
Z3660 Emulated UAE JIT 040 100MHz: Dhry: 98K, [Mflops: 16, Mips: 102](https://www.youtube.com/watch?v=QFajUKxel1U&t=1144s) </br>
3D REnder test: [1min 4sec "64sec"](https://www.youtube.com/watch?v=QFajUKxel1U&t=1206s) </br>
...
## Mouse & Joystick DB9
The Original Amiga "Tank Mouse", had different revisions 1351, 1352 & No name. </br>
