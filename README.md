...
Amiga 1200/4000 requires a fast CPU to do the conversion on CPU for AGA, but A4000 allows Zorro-3 [RTG](https://en.wikipedia.org/wiki/Retargetable_graphics) graphic cards. </br>
[AGA](https://en.wikipedia.org/wiki/Amiga_Advanced_Graphics_Architecture) is the basic on-board GPU that was far more advanced vs. previous generations of C64 & Amiga OCS 500/1000/2000 & 3000 [ECS](https://en.wikipedia.org/wiki/Amiga_Enhanced_Chip_Set) </br>
